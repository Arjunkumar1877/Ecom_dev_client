...
function OAuth() {
    ...
    return (
        <button onClick={handleGoogleClick} class="flex items-center bg-white border  rounded-lg shadow-md px-14 md:px-24 py-2 text-sm font-medium text-gray-800  hover:bg-gray-100">
