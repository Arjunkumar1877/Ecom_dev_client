...
const Header = () => {
  ...
  const bgColorClass = currentPath === '/' ? 'bg-Amal-green-transparent' : 'bg-Amal-green';
  const disableElements = currentPath === '/login' || currentPath === '/signup' ? "hidden" : "";
  ...
  return (
    <>
      <header className=" w-full z-50 top-0 overflow-hidden">
        ...
        <div className={`bg-Amal-ivory md:${bgColorClass}  py-4 sticky top-0 z-50`}>
          <div className="container mx-auto flex items-center justify-between">
            ...
            {/* Right Side: Icons */}
            <div className="flex items-center space-x-2 mr-5 w-24 ">
      ...
      <header
        className={`fixed z-50 top-0 w-full bg-Amal-ivory md:bg-Amal-green  transition-transform transform ${showSecondaryHeader ? 'translate-y-0' : '-translate-y-full'
          }`}
      >
